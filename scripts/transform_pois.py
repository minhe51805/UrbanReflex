...
Describe: Transform OSM POI GeoJSON to NGSI-LD PointOfInterest entities.
         Maps OSM amenity/leisure tags to FiWARE categories.
         Complies with ETSI NGSI-LD spec and FiWARE POI Data Model.
"""
