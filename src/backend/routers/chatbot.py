...
from ..ai_service.chatbot.embedding import get_embedding_manager, index_website_data
from ..ai_service.chatbot.pinecone_adapter import PineconeAdapter
from ..config.config import WEBSITE_CRAWL_URL, PINECONE_API_KEY, PINECONE_INDEX_NAME
import logging
