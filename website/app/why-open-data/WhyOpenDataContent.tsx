...
// Benefits data - extracted for better maintainability
const BENEFITS = [
  {
    title: 'Innovation',
    description: 'When data are open, everyone – civil society, government, private sector, academia – can help solve key social challenges.',
  },
  {
    title: 'Collaboration and knowledge sharing',
    description: 'Open data facilitates trust-building and knowledge exchange across organizational and geographical boundaries.',
  },
  {
    title: 'Equity',
    description: 'Open data access enables marginalized communities to understand and address disparities in their favor.',
  },
  {
    title: 'Improved decision-making',
    description: 'Citizens make better-informed choices when grounded in evidence rather than assumptions.',
  },
  {
    title: 'Public oversight and accountability',
    description: 'Transparent government data allows citizens to monitor officials and hold them responsible for their actions.',
  },
  {
    title: 'Reproducibility and scientific advancement',
    description: 'Open platforms enable verification of research methods and encourage new discoveries through shared data.',
  },
  {
    title: 'Efficiency',
    description: 'Open data reduces the time and effort users spend locating and acquiring information.',
  },
];
...
export default function WhyOpenDataContent() {
  ...
  // Memoize current URL to avoid repeated window.location.href calls
  ...
  // Optimize copy handler with useCallback
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              ...
              >
                <img
                  src="/assests/whyopendata/anh-whyopendata.png"
                  alt="Open data visualization showing urban data mapping and analysis"
              ...
              <div className="flex items-center gap-4 py-8 border-t border-neutral-soft-200">
                ...
                >
                  <svg height="20" viewBox="0 -960 960 960" width="20" fill="currentColor" aria-hidden="true">
                ...
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-white border border-neutral-soft-200 flex items-center justify-center hover:bg-neutral-soft-50 transition-colors"
                  aria-label="Share on Facebook"
                >
                  <svg fill="none" viewBox="0 0 18 18" width="20" height="20" aria-hidden="true">
      ...
      {/* Map Explorer Section - Optimized with lazy loading */}
